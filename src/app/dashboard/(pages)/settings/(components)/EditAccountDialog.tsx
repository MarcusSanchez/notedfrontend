...
import { CheckCircle, AlertCircle, Edit, User } from "lucide-react";
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <DialogDescription className="text-gray-600">
                Make changes to your account information. Click save when you're done.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-green-800">
                ...
                <ul className="space-y-1 text-green-700">
                  <li>• Use your real name for professional identification</li>
